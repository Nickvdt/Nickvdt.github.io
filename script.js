...
actionSpeech = (speechText) => {
  ...
  switch(speechText){ 
    ...
    case "star wars": // let op, "fall-through"
      image1.src = "./img/Battlefront2.webp";
      image1.style.width = "400px";
      image1.classList.remove("hide") // show image
      break;
    case "battlefront":
      window.open("https://store.steampowered.com/app/1237950/STAR_WARS_Battlefront_II/");
      break;
    case "help me":
      alert("Valid speech commands: Star Wars,  Battlefront, Nick, Reset");
      break;
    default:
      // do nothing yet
  }
